...
"""finetune LLaMA 7b with arithmetic model using llama adapter
"""
...
from joined_finetuning import joined_train_one_epoch, joined_val_one_epoch
...
class InstructionDataset(Dataset):
    def __init__(self, data_path, model_path, max_words=30, swift_max_words=128, partition="train"):
...
def get_args_parser():
    ...
    parser.add_argument("--model", default="Arth_Llama7B", type=str, metavar="MODEL", help="Name of model to train")
...
def main(args):
    ...
    # define the model
    model = model_arthllama.__dict__[args.model](args)
